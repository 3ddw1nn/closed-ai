...
export const eventStories: Record<string, EventStory> = {
  ...
  "suchir-balaji": {
    body: [
      `Suchir Balaji spent nearly four years at OpenAI, where his work included gathering and organizing the web data used to train GPT-4. He left in August 2024, having concluded that what the company was doing with copyrighted data was not defensible — telling the New York Times that if you believed what he believed, you had to leave.`,
      `In October 2024 he published an essay arguing that generative AI training fails the four factors of fair use, and was publicly named as a person with relevant documents in the Times' copyright case against OpenAI. On November 26, 2024, he was <a href="https://en.wikipedia.org/wiki/Suchir_Balaji" target="_blank" rel="noopener noreferrer">found dead in his San Francisco apartment</a>. He was 26.`,
      `The San Francisco medical examiner ruled the death a suicide, and police found no evidence of foul play. His parents have <a href="https://abc7news.com/post/parents-openai-whistleblower-suchir-balaji-dispute-suicide-ruling-he-would-not-harm-himself/19170809/" target="_blank" rel="noopener noreferrer">disputed the ruling</a>, commissioned an independent autopsy, and filed suit seeking records; their questions received widespread attention.`,
      `This entry carries no jokes. A young researcher looked at the most consequential technology of his time, decided the honest position was an uncomfortable one, said so publicly, and died a month later. Whatever else is true, the industry lost one of the few people who acted on principle at personal cost.`,
    ],
    aftermath: `The official ruling stands; his parents' civil litigation and public campaign continue. His fair-use critique remains cited in the ongoing copyright cases.`,
  },
